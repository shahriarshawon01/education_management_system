...
class LeaveCategorycontroller extends Controller
{
    ...
    {
        $this->model = new LeaveCategory();
    }

    public function index()
    {
        if (!can('leave_category_view')) {
    ...
    public function destroy($id)
    {
        ...
        return returnData(2000, [], 'Contact List Menu not found');
    }
}
