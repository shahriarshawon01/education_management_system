...
class NoticeBoardController extends Controller
{
    ...
    {
        $this->model = new NoticeBoard();
    }

    public function index()
    {
        if (!can('noticeboard_view')) {
    ...
    public function store(Request $request)
    {
        ...
        try {
            ...
            $this->model->slug = Str::slug($input['title']);
            $this->model->save();
