        ...
        <div class="row">
            <div class="col">
                <data-table :table-heading="[]"
                    ...
                    :defaultFilter="false" :default-pagination="false" table-title="Book Report"
                    :table-responsive="false">
                    <template v-slot:page_top>
                        <page-top :default-object="{}" topPageTitle="Stock Book Report" :default-add-button="false">
                    ...
                    <template v-slot:filter>
                        ...
                        <div class="col-md-1">
                            <select v-model="formFilter.edition_id" name="edition_id" class="form-control">
                                <option value="">Select Edition</option>
                                <template v-for="(eachData, index) in requiredData.books_edition">
                                    <option :value="eachData.id">{{ eachData.name }}</option>
                                </template>
                            </select>
                        </div>
                        <div class="col-md-1">
                            <select v-model="formFilter.book_type" name="book_type" class="form-control">
                        ...
                        <template v-if="dataList.data">
                            <div class="main-header mt-3">
                                <div class="row mb-3 mt-3">
                                    ...
                                    <schoolInfo title="Stock Books Report" />
