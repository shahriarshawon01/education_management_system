    ...
    <div class="main_component">
        <div class="row">
            <div class="col">
                <data-table :table-heading="tableHeading" table-title="Transport Component">
                    <template v-slot:page_top>
                        <page-top :default-object="{ component_id: '' }" topPageTitle="Transport Component"
                            :default-add-button="can('transport_component_add')"></page-top>
                    </template>
                        ...
                        <tr v-for="(data, index) in dataList.data">
                            ...
                            <td class="table-center">
                                <div class="hstack gap-3 fs-15 action-buttons" style="text-align: center;">
                                    <a v-if="can('transport_component_update')" class="link-primary"
                                        @click="editData(data, data.id)"><i class="fa fa-edit"></i></a>
                                    <!-- <a v-if="can('transport_component_delete')" class="link-danger"
                ...
                <div class="row">
                    <div class="col-md-12">
                        ...
                        <select v-model="formObject.component_id" class="form-control" v-validate="'required'">
                            ...
                            <template v-for="(data, index) in requiredData.transportComponent">
...
export default {
    ...
    mounted() {
        const _this = this;
        _this.getDataList();
        _this.getGeneralData(['transportComponent']);
    },
};
</script>
