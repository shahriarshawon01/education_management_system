            ...
            <div class="col">
                <data-table :table-heading="tableHeading" table-title="Transport Invoice"
                    ...
                    <template v-slot:page_top>
                        <page-top topPageTitle="Transport Invoice" page-modal-title="Transport Invoice"
                        ...
                        <tr v-for="(data, index) in dataList.data">
                            ...
                            <template v-if="data.invoice_type == '1'">
                                <td>
                                    ...
                                    <strong>Session : </strong>{{ data ? data.session_title : "" }}
                                </td>
                            </template>
                            ...
                            <template v-if="data.invoice_type == '4'">
                                <td>
                ...
                <div id="printInvoice" class="invoice-container" v-if="invoiceDetails && invoiceDetails.invoice">
                    <div class="invoice-header mb-3 p-3 border rounded shadow-sm bg-light">
                        <div>
                            ...
                            <span><strong>Transport User:</strong> {{
                                getInvoiceType(invoiceDetails.invoice.invoice_type)
                                }}</span><br />
                            <span><strong>Invoice Category:</strong>
                                {{ getInvoiceCategory(invoiceDetails.invoice.invoice_category) }}</span><br />
...
export default {
    ...
    data() {
        return {
            tableHeading: ["Sl", "Generate", "Invoice", "Transport User Details", "Created By", "Total Amount", "Waiver", "Payable", "Action"],
            invoiceDetails: [],
            years: [],
        };
    },
