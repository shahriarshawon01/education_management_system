<template :key="$route.meta.name">
    <div class="main_component">
        <div class="row">
            <div class="col">
                <data-table :table-heading="tableHeading" table-title="Designation">
                    <template v-slot:page_top>
                        <page-top :default-object="{}" topPageTitle="Designation"
                            :default-add-button="can('employee_designation_add')"></page-top>
                    </template>
                        ...
                        <tr v-for="(data, index) in dataList.data">
                            ...
                            <td class="table-center">
                                <div class="hstack gap-3 fs-15 action-buttons">
                                    <a v-if="can('employee_designation_update')" class="link-primary"
                                        @click="editData(data, data.id)"><i class="fa fa-edit"></i></a>
                                    <a v-if="can('employee_designation_delete')" class="link-danger"
...
export default {
    ...
    data() {
        return {
            tableHeading: ["Sl", "Designation Name", "Status", "Action"],
