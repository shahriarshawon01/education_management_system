<template :key="$route.meta.name">
    <div class="main_component">
        <div class="row">
            <div class="col">
                <data-table :table-heading="tableHeading" table-title="Session" :default-object="{ school: '' }">
                    <template v-slot:page_top>
                        <page-top topPageTitle="Session" page-modal-title="Session Add/Edit"></page-top>
                    </template>
        ...
        <formModal modalSize="modal-xs" @submit="submitForm(formObject, 'formModal')">
            <div class="mb-2">
                ...
                <input type="text" v-model="formObject.title" v-validate="'required'" name="title" class="form-control" placeholder="Enter Session Year">
            </div>
        </formModal>
    </div>
</template>
...
export default {
    ...
    data() {
        return {
            tableHeading: ['Sl', 'Session Year','Status', 'Action'],
        }
    },
    mounted() {
        const _this = this;
