<template :key="$route.meta.name">
    <div class="main_component">
        <div class="row">
            <div class="col">
                <data-table :table-heading="tableHeading" table-title="Group Subject">
                    <template v-slot:page_top>
                        <page-top :default-object="{}" topPageTitle="Group Subject"
                            :default-add-button="can('group_subject_add')"></page-top>
                    </template>
                        ...
                        <tr v-for="(data, index) in dataList.data">
                            ...
                            <td style="display:flex; justify-content: center">
                                <div class="hstack gap-3 fs-15">
                                    <a v-if="can('group_subject_update')" class="link-primary"
                                        @click="editData(data, data.id)"><i class="fa fa-edit"></i></a>
                                    <a v-if="can('group_subject_delete')" class="link-danger"
