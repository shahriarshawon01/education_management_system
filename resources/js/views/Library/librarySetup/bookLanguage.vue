            ...
            <div class="col">
                <data-table :table-heading="tableHeading">
                    <template v-slot:page_top>
                        <page-top topPageTitle="Book Language" page-modal-title="Add/Edit" v-if="can('language_add')"></page-top>
                    </template>
                        ...
                        <tr v-for="(data, index) in dataList.data">
                            ...
                            <td class="action-buttons">
                                <div class="hstack gap-3 fs-15">
                                    <a class="link-primary" v-if="can('language_update')" @click="editData(data, data.id)"><i class="fa fa-edit"></i></a>
                                    <a class="link-danger" v-if="can('language_delete')" @click="deleteInformation(index, data.id)"><i class="fa fa-trash"></i></a>
                                </div>
                            </td>
                        </tr>
                    </template>
