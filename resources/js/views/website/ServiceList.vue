<template :key="$route.meta.name">
    <div class="main_component">
        <div class="row">
          <div class="col">
            <data-table :table-heading="tableHeading" table-title="Service List">
              <template v-slot:page_top>
                <page-top :default-object="{school_id:''}" topPageTitle="Service List" :default-add-button="can('slider_add')" ></page-top>
              </template>
            ...
            <div class="mb-2">
                ...
                <div @click="clickImageInput('image')" class="mb-2 mt-3">
                      <div class="form-group image_upload" :style="{ backgroundImage: 'url(' + getImage(null, 'images/upload.png') + ')' }" style="background-size:260px !important">
                          <img v-if="formObject.logo" :src="getImage(formObject.image.path)">
