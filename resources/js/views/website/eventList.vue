<template :key="$route.meta.name">
    <div class="main_component">
        <div class="row">
          <div class="col">
            <data-table :table-heading="tableHeading" table-title="Event Component" >
              <template v-slot:page_top>
                <page-top :default-object="{school_id:'',event_type:''}" topPageTitle="Event Component" :default-add-button="can('event_add')" ></page-top>
              </template>
                ...
                <tr v-for="(data, index) in dataList.data">
                  ...
                  <td>
                    <div class="hstack gap-3 fs-15">
                      ...
                      <a v-if="can('event_update')" class="link-primary" @click="editData(data, data.id)"><i class="fa fa-edit"></i></a>
                      <a v-if="can('event_delete')" class="link-danger" @click="deleteInformation(index, data.id)"><i class="fa fa-trash"></i></a>
                    </div>
                  </td>
                </tr>
              </template>
        ...
        <formModal modalSize="modal-md" @submit="submitForm(formObject, 'formModal')">
            ...
            <div class="mb-2">
                ...
                <select  class="form-control" v-validate="'required'" v-model="formObject.event_type">
  ...
  export default {
    ...
    data() {
      return {
        tableHeading: ["Sl","Name","Description","Image","Status", "Action"],
