...
<head>
    ...
    {{--    <link href="{{ assets('backend_assets/libs/jsvectormap/css/jsvectormap.min.css') }}'" rel="stylesheet" type="text/css"/> --}}
...
<body class="{{ themeLayout() }} twocolumn-panel">
    ...
    <script src="{{ assets('js/student/student_app.js') }}" defer></script>
</body>
