<!DOCTYPE html>
<html lang="en" data-layout="{{ themeLayout() }}" data-topbar="light" data-sidebar="dark" data-sidebar-size="lg"
...
<head>
    ...
    <link rel="shortcut icon" href="{{ assets('images/logotpsc.png') }}">
    ...
    <link href="{{ assets('backend_assets/js/select2/select2/select2.min.css') }}" rel="stylesheet" type="text/css" />
    <link href="{{ assets('backend_assets/js/select2/select2-bootstrap.min.css') }}" rel="stylesheet" type="text/css" />
...
<body class="{{ themeLayout() }} twocolumn-panel">
    <div id="app">
        <App></App>
    </div>
    <script src="{{ assets('backend_assets/libs/jquery/jquery.min.js') }}"></script>
    <script src="{{ assets('backend_assets/js/select2/select2/select2.min.js') }}"></script>
