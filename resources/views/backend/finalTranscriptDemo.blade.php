                            ...
                            @php
                                ...
                                foreach ($sortedStudents[0]['subjects'] as $subjectGrouped) {
                                    foreach ($subjectGrouped['group_data'] as $subject) {
                                        ...
                                        if ($hasComponent && count($filteredExamNames) > 0) {
                                            $averageMark = $subjectTotal / count($filteredExamNames);
                                            $grandTotalMarks += $averageMark;
                                            $subjectGPA =
                                                $averageMark >= 80
                                                    ? 5
                                                    : ($averageMark >= 70
                                ...
                                foreach ($sortedStudents[0]['subjects'] as $subjectGrouped) {
                                    foreach ($subjectGrouped['group_data'] as $subject) {
                                        ...
                                        if ($hasComponent && count($filteredExamNames) > 0) {
                                            ...
                                            $grandTotalMarks += is_numeric($averageMark) ? $averageMark : 0;
                                            $totalGPA += is_numeric($subjectGPA) ? $subjectGPA : 0;
                                        }
                                    }
                                }
                                $finalGPA = $gpaSubjectCount > 0 ? round($totalGPA / $gpaSubjectCount, 2) : 0;
