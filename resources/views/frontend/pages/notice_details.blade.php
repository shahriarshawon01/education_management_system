...
<div class="overlay mt-2" style="padding: 15px 0px !important">
       <div class="container">
          <div class="col-md-12 text-center">
             <h1 class="page-title m-0">Notice Details</h1>
             <ul>
    ...
    <div class="container">
       <div class="row">
        <div class="col-12 pl-0">
            <h4 class="uppercase title pb-50 md-pb-30">{{$notice_details->title ?? ''}}</h4>
        </div>
       </div>
       <div class="row">
          <div class="col-md-12 pl-0 mx-auto">
            <div class="notice_info">
                <h6>Published Date : {{Carbon\Carbon::parse($notice_details->created_at)->format('d / F / y')}}</h6>
                <p>{{$notice_details->notice}} <a target="_blank" href="{{asset('storage/app/public/'.$notice_details->file)}}" download="{{asset('storage/'.$notice_details->file)}}" ><i class="ml-2 fa fa-download"></i> Download </a></p>
            </div>
          </div>
       </div>
    </div>
