...
<section class="page-header section-notch">
    ...
    <div class="overlay mt-2" style="padding: 15px 0px !important">
       <div class="container">
          <div class="col-md-12 text-center">
             <h1 class="page-title m-0">About the Institute</h1>
             <ul>
                <li><a class="active" href="{{url('/')}}">Home</a> / <span style="color: #FFFFFF!important;">About</span></li>
             </ul>
          </div>
       </div>
    </div>
 ...
 <div id="rs-about" class="rs-about sec-spacer about-us" style="padding-top: 100px">
    <div class="container">
             ...
             <div class="col-lg-6 col-md-12">
                <div class="about-img rs-animation-hover">
                    @if ($video && $video->video_link)
                        <img src="{{asset('storage/'.$school_info->logo)}}" alt="{{$school_info->title ?? ''}}">
