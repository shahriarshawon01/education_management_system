    ...
    <div class="overlay mt-2" style="padding: 15px 0px !important">
       <div class="container">
          <div class="col-md-12 text-center">
             <h1 class="page-title m-0">MD Message</h1>
             <ul>
                <li><a class="active" href="{{url('/')}}">Home</a> / <span style="color: #FFFFFF!important;">MD Message</span></li>
             </ul>
          </div>
       </div>
    </div>
...
<div id="rs-about" class="rs-about sec-spacer about-us" style="padding-top: 80px">
    <div class="container" style="padding: 10px">
        ...
        <div class="about-desc">
             <img style="float: right; margin: -122px 0px 10px 10px;" width="20%" src="{{assets('frontend_assets/images/ed_photo.jpg')}}">
            <p style="text-align: justify;">{{$md_message->value ?? '' }} </p>
        </div>
    </div>
</div>
