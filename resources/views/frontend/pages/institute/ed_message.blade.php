...
<div class="overlay mt-2" style="padding: 15px 0px !important">
         <div class="container">
            <div class="col-md-12 text-center">
               <h1 class="page-title m-0">Executive Director Message</h1>
               <ul>
                  <li><a class="active" href="{{url('/')}}">Home</a> / <span style="color: #FFFFFF!important;">ED Message</span></li>
               </ul>
            </div>
         </div>
      </div>
...
<div id="rs-about" class="rs-about sec-spacer about-us" style="padding-top: 80px">
    <div class="container" style="padding: 15px">
        <div class="abt-title">
            <h2>Executive Director Message</h2>
        </div>
        <div class="about-desc">
           <img style="float: right; margin: 6px 0px 10px 10px; border-radius: 4px;" width="16%" src="{{assets('frontend_assets/images/ed_photo.jpg')}}">
            <p style="text-align: justify;">{{$ed_message->value ?? '' }} </p>
        </div>
    </div>
</div>
