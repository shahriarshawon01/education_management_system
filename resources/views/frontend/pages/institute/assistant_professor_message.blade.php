...
@section('title','Assistance Prefessor Message')
...
<div class="overlay mt-2" style="padding: 15px 0px !important">
       <div class="container">
          <div class="col-md-12 text-center">
             <h1 class="page-title">Assistant Professor Message</h1>
             <ul>
                <li><a class="active" href="{{url('/')}}">Home</a> / <span style="color: #FFFFFF!important;">Assistant Professor Message</span></li>
             </ul>
          </div>
       </div>
    </div>
...
<div id="rs-about" class="rs-about sec-spacer about-us" style="padding-top: 80px">
    <div class="container" style="padding: 10px;">
        <div class="abt-title">
            <h2>Assistant Professor Message</h2>
        </div>
        <div class="about-desc">
           <img style="float: right; margin: -50px 0px 10px 10px;" width="20%" src="{{assets('frontend_assets/images/assistant_professor.jpg')}}">
            <p style="text-align: justify;">{{$assistant_professor_message->value ?? '' }} </p>
        </div>
    </div>
</div>
