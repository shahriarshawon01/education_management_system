...
<section class="page-header section-notch">
      ...
      <div class="overlay mt-2" style="padding: 15px 0px !important">
       <div class="container">
          <div class="col-md-12 text-center">
             <h1 class="page-title m-0">Mission & Vision</h1>
             <ul>
                <li><a class="active" href="{{url('/')}}">Home</a> / <span style="color: #FFFFFF!important;">Mission Vision</span></li>
             </ul>
          </div>
       </div>
    </div>
 ...
 <div id="rs-about" class="rs-about sec-spacer about-us" style="padding-top: 90px">
    <div class="container">
        <div class="row">
             <div class="col-12">
                <div class="abt-title">
